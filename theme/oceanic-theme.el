...
(custom-theme-set-faces
  'oceanic
  '(default ((t (:foreground "#cccccc" :background "#1B2B34"))))
  ...
  '(linum ((t (:foreground "#586e75" :background "#1B2B34" :weight normal))))
  '(mode-line ((t (:background "#6699CC" :foreground "#1B2B34"
                               :box "#6699CC" :weight normal))))
  '(mode-line-highlight ((t (:box nil))))

  '(vertical-border ((t (:foreground "#426073"))))
  '(fringe ((t (:background "#1B2B34"))))
