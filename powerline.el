...
(defface powerline-active3 '((t (:foreground "black" :background "OliveDrab3" :inherit mode-line)))
  "Powerline face 3."
  :group 'powerline)

(defface powerline-inactive1
  '((t (:foreground "white" :background "grey22" :inherit mode-line-inactive)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-inactive2
  '((t (:foreground "white" :background "grey44" :inherit mode-line-inactive)))
  "Powerline face 2."
  :group 'powerline)
...
(eval-after-load 'evil
  '(progn
     (defface powerline-evil-insert-face
       '((((class color))
          :foreground "#191919" :background "green" :weight bold :inherit mode-line)
         (t (:weight bold)))
     ...
     (defface powerline-evil-normal-face
       '((((class color))
          :foreground "#191919" :background "#1D8CCD" :weight bold :inherit mode-line)
         (t (:weight bold)))
     ...
     (defface powerline-evil-visual-face
       '((((class color))
          :foreground "#191919" :background "DarkOrange" :weight bold :inherit mode-line)
         (t (:weight bold)))
     ...
     (defface powerline-evil-operator-face
       '((((class color))
          :foreground "black" :background "sky blue" :weight bold :inherit mode-line)
         (t (:weight bold)))
